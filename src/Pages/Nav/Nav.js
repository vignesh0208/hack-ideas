    ...
    <>
        ...
        <div className='px-3 py-3 lg:px-5 lg:pl-3'>
          <div className='flex items-center justify-between'>
            <div className='flex items-center justify-start rtl:justify-end'>
              <Button
                buttonType='button'
                extraClassName='inline-flex items-center p-2 text-sm text-gray-500 rounded-lg sm:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600'
                handleClick={() => setOpenSideMenu(!isOpenSideMenu)}>
            ...
            <div className='flex items-center'>
              <div className='flex items-center ms-3'>
                <div>
                  <Button
                    buttonType='button'
                    extraClassName='flex text-sm bg-gray-800 rounded-full focus:ring-4 focus:ring-gray-300 dark:focus:ring-gray-600'
                    handleClick={() => setOpenUserMenu(!isOpenUserMenu)}>
      ...
      <aside
        ...
        className={`fixed top-0 left-0 z-40 w-64 h-screen pt-20 transition-transform bg-white border-r border-gray-200 sm:translate-x-0 dark:bg-gray-800 dark:border-gray-700 ${
          isOpenSideMenu ? 'transform-none' : '-translate-x-full'
        }`}
        aria-label='Sidebar'>
      ...
      <div className='h-full p-4 overflow-y-auto sm:ml-64'>
